...
/**
 * Validates post parameters for Kantor Cabang creation operation.
 */
class StoreKantorCabangRequest
{
    /**
    ...
    public function validate(array $data): array
    {
        ...
        } elseif (KantorCabang::where('office_code', $officeCode)->exists()) {
        ...
        if (!empty($errors)) {
            throw new ValidationException($errors, 'Silakan periksa kembali data input kantor cabang baru.');
        }
